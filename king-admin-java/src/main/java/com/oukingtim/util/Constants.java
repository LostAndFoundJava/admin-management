...
public final class Constants {
    ...
    public static final String VISA_SERVER_ADMIN = "http://47.97.201.63:8081/visa";//47.97.201.63
    public static final String EXCEL_SERVER_ADMIN = "http://47.97.201.63:8081/excel";//47.97.201.63
    public static final String HOST = "47.97.201.63";
    public static final int PORT = 21;
    public static final String PIC_BASE_PATH = "/home/admin/pic";
    public static final String VISA_BASE_PATH = "/home/admin/visa";
