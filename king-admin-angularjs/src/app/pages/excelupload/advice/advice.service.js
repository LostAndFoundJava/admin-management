(function () {
    ...
    /** @ngInject */
    function AdviceService($resource, Upload, toastr, CommonService) {
        var rest = $resource('mgr/advice/management/:id', {}, {
            'create': {method: 'POST'},
            'update': {method: 'PUT'},
        });

        function getSmartData(param, callback) {
            $resource('mgr/advice/management/getSmartData', {}, {
                'query': {method: 'POST'}
            }).query(param,
                function (data) {
                    console.log(data);
        ...
        function exportData(param, callback) {
            $resource('mgr/advice/management/export', {}, {
                'query': {method: 'POST'},
        ...
        function getList(param, callback) {
            $resource('mgr/advice/management/getlist').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
        ...
        /*function deal(param, callback) {
            CommonService.info('确定修改?', function () {
                $resource('mgr/advice/management/deal/:id').get(param,
                    function (data) {
                        console.log(data);
                        callback(data);
                    }, function (error) {
        ...
        function deal(param, callback) {
            CommonService.info('确定修改?', function () {
                $resource('mgr/advice/management/deal/:id', {}, {
                    'update': {method: 'GET'}
                }).update(param,
                    function (data) {
                        console.log(data);
