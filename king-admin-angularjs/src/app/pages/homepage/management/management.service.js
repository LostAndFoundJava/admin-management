(function () {
    ...
    /** @ngInject */
    function HomepageService($resource, toastr, CommonService) {

        var rest = $resource('mgr/homepage/management/:id', {}, {
            'create': {method: 'POST'},
            'update': {method: 'PUT'},
        });

        function getSmartData(param, callback) {
            $resource('mgr/homepage/management/getSmartData', {}, {
                'query': {method: 'POST'}
            }).query(param,
                function (data) {
                    console.log(data);
        ...
        function getList(param, callback) {
            $resource('mgr/homepage/management/getlist').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
        ...
        function getExhibitions(param, callback) {
            $resource('mgr/homepage/management/exhibitions').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
