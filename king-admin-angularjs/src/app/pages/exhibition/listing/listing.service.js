(function () {
    ...
    /** @ngInject */
    function ListingService($resource ,toastr,CommonService) {

        var rest = $resource('api/mgr/exhibition/listing/:id', {}, {
            'create': {method: 'POST'},
            'update': {method: 'PUT'},
        });
        function getSmartData(param,callback) {
            $resource('api/mgr/exhibition/listing/getSmartData', {}, {
                'query': {method: 'POST'}
            }).query(param,
                function (data) {
                    console.log(data);
        ...
        function getList(param,callback) {
            $resource('api/mgr/exhibition/listing/getlist').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
