(function () {
    ...
    /** @ngInject */
    function LinkService($resource, toastr, CommonService) {

        var rest = $resource('mgr/link/management/:id', {}, {
            'create': {method: 'POST'},
            'update': {method: 'PUT'},
        });

        function getSmartData(param, callback) {
            $resource('mgr/link/management/getSmartData', {}, {
                'query': {method: 'POST'}
            }).query(param,
                function (data) {
                    console.log(data);
        ...
        function getExhibitions(param, callback) {
            $resource('mgr/link/management/exhibitions').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
        ...
        function getSomeExhibitions(param, callback) {
            $resource('mgr/link/management/someExhibitions').get(param,
                function (data) {
                    console.log(data);
                    callback(data);
                }, function (error) {
